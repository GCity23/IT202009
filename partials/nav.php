            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if (has_role("Admin")) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-warning" aria-labelledby="rolesDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/list_items.php'); ?>">List Item</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if (has_role("Shop Owner")) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-warning" aria-labelledby="rolesDropdown">
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/Order_History.php'); ?>">All Order History</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if (is_logged_in()) : ?>
